...
# class which will result in data being returned must first call 
# a logging class. The logging class has been supplied to Alyssa 
...
# as an additional argument. It may be helpful to review the lecture 
